...
def train(args, trainer, task, epoch_itr):
    ...
    for i, samples in enumerate(progress):
        ...
        valid_losses, should_stop = validate_and_save(args, trainer, task, epoch_itr, valid_subsets, end_of_epoch)
...
def validate_and_save(args, trainer, task, epoch_itr, valid_subsets, end_of_epoch):
    ...
    do_save = (
        ...
        or (args.save_interval_updates > 0 and num_updates > 0 and num_updates % args.save_interval_updates == 0 and num_updates >= args.validate_after_updates)
    )
    do_validate = (
    ...
    should_stop = (
        ...
        or num_updates >= max_update
        or (args.stop_time_hours > 0 and trainer.cumulative_training_time() / (60 * 60) > args.stop_time_hours)
    )
