...
# File path
TRAIN_SRC_FILE=../data/hsk+mucgec_dev+nlpcc18_test+cged/src.txt
TRAIN_TGT_FILE=../data/hsk+mucgec_dev+nlpcc18_test+cged/tgt.txt
VALID_SRC_FILE=../data/yaclc-minimal_dev/src.txt
VALID_TGT_FILE=../data/yaclc-minimal_dev/tgt.txt
