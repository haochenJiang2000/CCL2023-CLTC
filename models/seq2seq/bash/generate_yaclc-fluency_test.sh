...
python ../utils/post_process_chinese.py $OUTPUT_DIR/yaclc-fluency_test.src.char $OUTPUT_DIR/yaclc-fluency_test.out $OUTPUT_DIR/yaclc-fluency_test.id $OUTPUT_DIR/yaclc-fluency_test.out.post_processed
